  ...
  return (
    <AuthLayout title="Sign in" subtitle="Welcome back! Please sign in to continue">
      <form className="w-full flex flex-col items-center justify-center" onSubmit={handleLogin} noValidate>
        ...
        {fieldErrors.email && <p className="text-red-500 text-xs mt-1 w-full pl-4">{fieldErrors.email}</p>}
        ...
        {fieldErrors.password && <p className="text-red-500 text-xs mt-1 w-full pl-4">{fieldErrors.password}</p>}
